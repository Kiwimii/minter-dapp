...
const namePrefix = "SHT Head";
const description = "A random collection of Sht Heads";
...
const CONTRACT_NAME = 'SHT Head';
const CONTRACT_SYMBOL = 'SHT';
...
const MINT_PRICE = 0.5; // Minting price per NFT. Goerli = ETH, Ethereum = ETH, Polygon = MATIC. CANNOT BE UPDATED!
...
const ROYALTY_ADDRESS = "0xE109cE0a431E0B04318D96f962970ad94f390120"; // Address that will receive the royalty
...
const solanaMetadata = {
  ...
  creators: [
    {
      address: "3atmLWvNpUQwYpda3aRq4H6evoo6YWCS56D3aLN67p2x",
      share: 100,
    },
  ],
};
