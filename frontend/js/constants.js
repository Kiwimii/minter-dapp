const contractAddress = "0x78b38551744368e18c1CAA11177F9AA9b6887F01"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the Sht Head NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Sht Head NFT Project is a decentralized, open-source project that aims to demonstrate nothing. Get your own shit done. Limited to only 4444.';
